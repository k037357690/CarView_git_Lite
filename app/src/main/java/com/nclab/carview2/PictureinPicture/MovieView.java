package com.nclab.carview2.PictureinPicture;
...
public class MovieView extends RelativeLayout {
    ...
    private Button button,bStartStop, bRecord,bJam,bCarAccident,bRoadConstruction,small,switchCamera;
    ...
    public MovieView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        small = findViewById(R.id.windowsmall);
