...
public abstract class ContextReference<T> extends WeakReference<T> implements IonContext{
    ...
    public static class SupportFragmentContextReference extends ContextReference<androidx.core.app.Fragment> {
        public SupportFragmentContextReference(androidx.core.app.Fragment fragment) {
            super(fragment);
        }

        @Override
        public Context getContext() {
            androidx.core.app.Fragment fragment = get();
            if (fragment == null)
                return null;
            return fragment.getActivity();
        }
