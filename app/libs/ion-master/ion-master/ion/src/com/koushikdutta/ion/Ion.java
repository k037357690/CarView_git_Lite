...
public class Ion {
     ...
     * @return
     */
    public static LoadBuilder<Builders.Any.B> with(androidx.core.app.Fragment fragment) {
        return getDefault(fragment.getActivity()).build(fragment);
    }
     ...
     * @return
     */
    public LoadBuilder<Builders.Any.B> build(androidx.core.app.Fragment fragment) {
